...
Open http://localhost:3000. Paste a Jev API key (get one at https://console.typesafe.ai/keys — early access; pasting auto-verifies and unlocks the page), enable the metrics you want, hit the mic button (or "Sample" / type in the box), and watch the scores update.
